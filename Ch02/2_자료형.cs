...
namespace Ch02
{
    internal class _2자료형
    {
        static void Main(string[] args)
        {
            ...
            short num2 = 32767; //-32,768 ~ 32,767 2byte
            int num3 = 2147483647; //가장 많이 씀 4byte
            long num4 = 92233720368477507L; // 8byte 정리사 L
            ...
            //실수형
            float var1 = 0.123456789f; //정리사f 8자리
            double var2 = 0.1234567890123456789; //16자리
            ...
            // object형 타입 구분없이 다 쓸 수 있음 잘 쓰진 않음 객체로 저장,,
            object obj1 = 10;
            object obj2 = 3.14;
            object obj3 = true;
            object obj4 = 'A';
