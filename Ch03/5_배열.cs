...
namespace Ch03
{
    internal class _5_배열
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("arr2 배열 길이 :"+arr3.Length);
            Console.WriteLine("arr3 배열 길이 :"+arr2.Length);
            ...
            Console.WriteLine("arr3d[2,0,0] :"+ arr3d[0, 0, 2]);  //높은 차원부터 차례대로
            Console.WriteLine("arr3d[1,1,0] :"+ arr3d[0, 1, 1]);
            Console.WriteLine("arr3d[1,0,1] :"+ arr3d[1, 0, 1]);
            Console.WriteLine("arr3d[2,1,1] :"+ arr3d[1, 2, 1]);
            Console.WriteLine("arr3d[0,2,2] :"+ arr3d[2, 2, 0]);
        }
    }
}
